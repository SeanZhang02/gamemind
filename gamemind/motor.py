...
_STALENESS_TIMEOUT_MS = 10000.0  # must exceed VLM tick interval (~6s for spatial perception)
_RECOVERY_THRESHOLD = 1  # resume immediately on first valid command (was 2)
